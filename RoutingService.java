...
import com.rwtool.repository.PathConfigRepository;
import com.rwtool.repository.RoutingLogRepository;
import org.springframework.stereotype.Service;
import org.springframework.beans.factory.annotation.Value;
import com.rwtool.sharepoint.SharePointService;
...
public class RoutingService {
    ...
    public RoutingService(PathConfigRepository pathConfigRepository, RoutingLogRepository routingLogRepository, SharePointService sharePointService, NotificationService notificationService) {
    ...
    private Map<String, Object> routeSingleLocal(String fileName) {
        ...
        try {
            ...
            try {
                String[] parts = outRel.split("/");
                String domain = parts.length > 1 ? parts[1] : outRel;
                notificationService.notifyAdmin(
                        "FILE_ADDED",
                        "New File Added",
                        fileName + " added to " + domain + " folder"
                );
